...
{
    public float deviceAccelerometerSensitivity = 2f; // how sensistive our mobile accelerometer will be
    public float deadZone = .001f;
    public float horizontal; //horizonal input control, either mobile or keyboard
    public float maxSpeedToTurn = 0.25f; //keeps car from turning until it's reached this value

    // physical transforms for the car's wheels
    ...
    public float turnSpeed = 2.5f; //keep this value somewhere between 2.5 and 6
    ...
    void InitializeCar()
    {
        ...
        // call to set up our wheel array
        SetUpWheels();
        // we set a Center Of Gravity here and lower the center of mass to a
    ...
    void CheckInput()
    {
        //Mobile platform turning input...testing to see if we are on mobile device
    ...
    void CarPhysicsUpdate()
    {
        ...
        //calculate current speed (magnitude of the flat velocity)
        ...
        // calculate impulses to stimulate grip by taking our right vector, reversing the slidespeed and
    ...
    void EngineSound()
    {
        ...
        //ensures we dont exceed too crazy of a pitch by resetting it back to default 2
